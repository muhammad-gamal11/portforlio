const ProjectsCard = ({ image, title, category, href, src }) => {
  return (
    <div className="w-full h-96 py-8 flex flex-col justify-center items-center border-b-[1px] border-b-zinc-800">
